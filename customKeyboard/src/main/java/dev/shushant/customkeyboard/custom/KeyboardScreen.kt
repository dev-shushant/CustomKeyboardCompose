package dev.shushant.customkeyboard.custom
...
import androidx.compose.ui.unit.dp
import dev.shushant.customkeyboard.keyboard.IMEService
...
@Composable
fun KeyboardKey(
    keyboardKey: String, modifier: Modifier
) {
        ...
        if (pressed.value) {
            Text(
                ...
                modifier = Modifier
                    ...
                    .background(Color.White)
                    .padding(
                        start = 16.dp, end = 16.dp, top = 16.dp, bottom = 48.dp
                    ),
                textAlign = TextAlign.Center,
            )
        }
